...
#include <kernel/drivers/sys_device.h>
...
#define DEV_IOC_USR_HWSC_USB_HID_START          (DEV_IOC_USR_BASE + 204)    /* 保留                                         */
#define DEV_IOC_USR_HWSC_USB_HID_REMOVE         (DEV_IOC_USR_BASE + 205)    /* 保留                                         */
