...
typedef struct __INPUT_DEV
{
    ...
    /* 物理事件处理函数 */
    __s32(*event)(struct __INPUT_DEV *dev, __u32 type, __u32 code, __s32 value);

    /* 物理事件缓存区，收到EV_SYN后会转移到循环队列 */
    __u32 evbuf[INPUT_EV_BUFFER_MAXLEN];
    /*  物理事件当前指针 */
    __s32 ev_pos;
} __input_dev_t;
...
extern __s32 esINPUT_RegDev(__input_dev_t *dev);
extern __s32 esINPUT_UnregDev(__input_dev_t *dev);
extern __hdle esINPUT_LdevGrab(char *ldev, __pCBK_t callback, void *pArg, __s32 aux);
extern __s32 esINPUT_LdevRelease(__hdle graber);
extern __s32 esINPUT_SendEvent(__input_dev_t *dev, __u32 type, __u32 code, __s32 value);
extern __s32 esINPUT_LdevFeedback(__hdle graber, __input_event_packet_t *packet);
extern __s32 esINPUT_GetLdevID(__hdle graber);
extern __s32 esINPUT_LdevCtl(__s32 LdevId, __s32 cmd, __s32 aux, void *pBuffer);
