...
#define     SUNXI_MBR_SIZE  (1 * 1024)
#define     SUNXI_DL_SIZE   (16 * 1024)
#define     SUNXI_MBR_MAGIC "softw311"
#define     SUNXI_MBR_MAX_PART_COUNT    15
#define     SUNXI_MBR_COPY_NUM          4    //mbr的备份数量
#define     SUNXI_MBR_RESERVED          (SUNXI_MBR_SIZE - 20 - (SUNXI_MBR_MAX_PART_COUNT * sizeof(sunxi_partition)))   //mbr保留的空间
...
//  unsigned  int       keydata;        //关键数据，要求量产不丢失
    ...
    unsigned  char      reserved[16];   //保留数据，匹配分区信息128字节
