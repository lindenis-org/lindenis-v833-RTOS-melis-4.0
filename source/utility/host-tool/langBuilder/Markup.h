...
public:
    ...
    static CString UnescapeText(CString szText, int nTextLength = -1);
...
protected:
    ...
    struct TokenPos
    {
        ...
        bool Match(CString sz)
        {
            LPCTSTR szName = sz.c_str();
            int nLen = nR - nL + 1;
    ...
    int x_FindElem(int iPosParent, int iPos, CString szPath) const;
