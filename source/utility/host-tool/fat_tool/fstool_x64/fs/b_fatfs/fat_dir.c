...
inline void fat16_towchar(wchar_t *dst, const __u8 *src, unsigned int len)
{
#ifdef __BIG_ENDIAN
    while (len--)
    {
...
inline void fatwchar_to16(__u8 *dst, const wchar_t *src, unsigned int len)
{
#ifdef __BIG_ENDIAN
    while (len--)
    {
