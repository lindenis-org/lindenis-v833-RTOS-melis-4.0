...
struct dentry_operations vfat_dentry_ops[4] =
{
    {
        .d_hash     = vfat_hashi,
        .d_compare  = vfat_cmpi,
...
static   wchar_t vfat_bad_char(wchar_t w)
{
    return (w < 0x0020)
           || (w == '*') || (w == '?') || (w == '<') || (w == '>')
           || (w == '|') || (w == '"') || (w == ':')
...
static   wchar_t vfat_replace_char(wchar_t w)
{
    return (w == '[') || (w == ']') || (w == ';') || (w == ',')
           || (w == '+') || (w == '=');
}
...
static   int vfat_is_used_badchars(const wchar_t *s, int len)
{
    int i;
                                 ...
                                 unsigned char *name_res, unsigned char *lcase)
{
    ...
    unsigned char base[9], ext[4], buf[11], *p;
    ...
    *lcase = 0;
    ...
    {
        sprintf(buf, "%X", i);
        memcpy(&name_res[baselen], &buf[6], 4);
        if (vfat_find_form(dir, name_res) < 0)
            break;
        i -= 11;
    }
