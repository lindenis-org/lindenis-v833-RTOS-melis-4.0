        ...
        void *objp, int colour_off, int local_flags)
{
    ...
    else
    {
         ...
         */
        slabp = (void *)((int)objp + colour_off);
        colour_off += L1_CACHE_ALIGN(cachep->num *
                                     sizeof(kmem_bufctl_t) + sizeof(slab_t));
    }
    slabp->inuse = 0;
    slabp->colouroff = colour_off;
    slabp->s_mem = (void *)((int)objp + colour_off);
        ...
        slab_t *slabp, unsigned long ctor_flags)
{
    ...
    for (i = 0; i < cachep->num; i++)
    {
        void *objp = (void *)((int)slabp->s_mem + cachep->objsize * i);
        ...
        slab_t *slabp)
{
    ...
    /* get obj pointer */
    slabp->inuse++;
    objp = (void *)((unsigned int)slabp->s_mem + slabp->free * cachep->objsize);
