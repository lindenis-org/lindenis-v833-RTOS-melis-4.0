...
typedef struct
{
    char  *script_mod_buf;              //pointer to the first mainkey.
    int    script_mod_buf_size;
    int    script_main_key_count;       //backup the mainkey count number.
} script_parser_t;
...
int script_parser_exit(void *hparser)
{
    script_parser_t *parser = NULL;
...
int script_parser_fetch(void *hparser, char *main_name, char *sub_name, int value[], int count)
{
...
int script_parser_subkey_count(void *hparser, char *main_name)
{
...
int script_parser_mainkey_count(void *hparser)
{
    script_parser_t *parser;
...
int script_parser_mainkey_get_gpio_count(void *hparser, char *main_name)
{
    char   main_bkname[32];
    char   *main_char;
    script_sub_key_t   *sub_key = NULL;
...
int script_parser_mainkey_get_gpio_cfg(void *hparser, char *main_name, void *gpio_cfg, int gpio_count)
{
    char   main_bkname[32];
    char   *main_char;
    script_sub_key_t   *sub_key = NULL;
