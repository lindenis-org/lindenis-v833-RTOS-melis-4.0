...
__fsys_part_t *pPartFTbl[FSYS_MAX_FPARTS] = {0}; /* 自由分配的分区列表 */
__fix_part_t  pPartXTbl[FSYS_MAX_XPARTS] =      /* 系统内部固定分配的分区列表 */
{
    {'A', 0}, {'B', 0}, {'C', 0}, {'D', 0}, {'W', 0}, {'X', 0}, {'Y', 0}, {'Z', 0}
};
__fix_part_t pPartUTbl[FSYS_MAX_UPARTS] =      /* 方案用户自定义分区的分区列表 */
{
    {'U', 0}, {'V', 0}
};
...
static __hdle   pContolSem;         /* 分区挂载线程唤醒、睡眠控制锁 */
__hdle          CurhNode;
