...
#define O_CREAT         00001000  /* not fcntl */
#define O_EXCL          00004000  /* not fcntl */
#define O_NOCTTY        00000400  /* not fcntl */
#define O_TRUNC         00002000  /* not fcntl */
...
{
    __s32(*llseek)(struct file *, __s64, __s32);
...
extern __s32 no_llseek(struct file *file, __s64 offset, __s32 origin);
extern __s32 generic_file_llseek(struct file *file, __s64 offset, __s32 origin);
