...
int fs_log_handler_fprintf(const char *function, const char *file,
                           int line, __u32 level, void *data,
...
void __int2str_dec(int input, char *str)
{
    char stack[12];
...
ll_check:
            ...
            switch (*str)
            {
                ...
                case 'i':
                    ...
                    {
                        __int2str_dec(va_arg(argp,  __s32), string);
                        gap_flag ^= 1;
                    }
                    rt_strcpy(_p, p);
                    _p += rt_strlen(p);
                ...
                case 'X':
                    ...
                    {
                        __int2str_hex(va_arg(argp,  __s32), string, hex_flag);
                        gap_flag ^= 1;
                    }
                    rt_strcpy(_p, p);
                    _p += rt_strlen(p);
                ...
                case 'u':
                    ...
                    {
                        __uint2str_dec(va_arg(argp,  __s32), string);
                        gap_flag ^= 1;
                    }
                    strcpy(_p, p);
                    _p += strlen(p);
