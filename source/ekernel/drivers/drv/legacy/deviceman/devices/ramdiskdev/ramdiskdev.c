...
static __hdle ramdiskdev_open(void *open_arg, __u32 mode)
{
...
static __s32 ramdiskdev_close(__hdle hDev)
{
    if (ramdiskdev.used == 0)
    {
        return EPDK_FAIL;
...
static __u32 ramdiskdev_read(void *pBuffer, __u32 blk, __u32 n, __hdle hDev)
{
...
static __u32 ramdiskdev_write(const void *pBuffer, __u32 blk, __u32 n, __hdle hDev)
{
    if (blk >= RAMDISK_BLK_NUMBER)
    {
        return 0;  /* Out of physical range */
...
static __s32 ramdiskdev_ioctrl(__hdle hDev, __u32 Cmd, __s32 Aux, void *pBuffer)
{
