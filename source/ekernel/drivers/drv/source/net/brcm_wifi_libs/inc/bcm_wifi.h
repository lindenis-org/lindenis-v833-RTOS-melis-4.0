...
// Application APIs
//
extern void bcm_wifi_start(unsigned char country[2]);
...
int mhd_is_use_wifi_resume(void);
...
int mhd_tcpka_clear_all( void );
int mhd_sta_wowl_init_bin(const char *pattern_hex,int pattern_len,int offset);
